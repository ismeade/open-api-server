...
public class SignVerifierTest {
    ...
    public void check() throws Exception {
        assertEquals(ReturnCode.MESSAGE_INCOMPLETE, new SignVerifier(json).check());
        assertEquals(ReturnCode.ILLEGAL_MESSAGE, new SignVerifier(noJson).check());
        assertEquals(ReturnCode.ILLEGAL_MESSAGE, new SignVerifier(nullStr).check());
        assertEquals(ReturnCode.SUCCESS, new SignVerifier(dataJson).check());
    }
